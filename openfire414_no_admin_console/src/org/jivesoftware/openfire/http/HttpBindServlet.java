...
public class HttpBindServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException
    {
    	Log.info("---jaydon--HttpBindServlet---doGet---");
    	...
    	Log.info("---jaydon--queryString 1---"+queryString);
        ...
        Log.info("---jaydon--queryString 2---"+queryString);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
    	Log.info("---jaydon--HttpBindServlet---doPost---");
        final AsyncContext context = request.startAsync();
            ...
            throws IOException
    {
        ...
        Log.info("---jaydon--rootNode.asXML()---"+rootNode.asXML());
...
//当所有数据读取完成时激发该方法；
        ...
        public void onAllDataRead() throws IOException {
            ...
            Log.info(" ---jaydon--onAllDataRead---remoteAddress-"+remoteAddress);
    ...
    private static class WriteListenerImpl implements WriteListener {
        ...
        public void onWritePossible() throws IOException {
        	 Log.info(" ---jaydon--onWritePossible---remoteAddress-"+remoteAddress);
